      ...
      <div className="project__list  h-full pt-24 pb-24">
        <div className="layout">
          <div className="header flex items-center justify-between">
            <h1>Projects</h1>
            <button
              className="add-project flex items-center  py-2 px-4 rounded text-white"
              onClick={togglePopup}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <Popup
                content={
                  <>
                    ...
                    <button className="add-project flex items-center  py-2 px-4 rounded text-white">
                      Submit
                    </button>
                  </>
                }
          ...
          <div className="project__list--items mt-20 ">
            <div className="project__list--item flex justify-between items-center px-4 py-4 bg-white mb-2">
              <div className="title  w-2/5">
                <div className="project-title font-bold">
                  <a href="#">Earts-Nepal</a>
                </div>
                <div class="deadline text-sm">
            ...
            <div className="project__list--item flex justify-between items-center px-4 py-4 bg-white mb-2">
              ...
              <div class="project-status w-1/5">
                Status:
                <span className="font-bold pl-2">Running</span>
              </div>
            </div>
            <div className="project__list--item flex justify-between items-center px-4 py-4 bg-white mb-2">
              <div className="title  w-2/5">
                <div className="project-title font-bold">
                  <a href="#">GKT website</a>
                </div>
                <div class="deadline text-sm">
                  Estimated deadline: 26 Apr, 2021
                </div>
